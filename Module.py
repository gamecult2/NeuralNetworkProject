...
def run_gravity(steps=10):
    ...
    ops.recorder('Node', '-file',
                 os.path.join('../DynamicSystem/Result_files/', 'Gravity_Reactions.out'),
...
def run_modal(n_evs=3):
    """
    Runs Modal analysis. The model should be built before
    Keyword arguments:
    ...
    ops.recorder('Node', '-file',
                 os.path.join('../DynamicSystem/Result_files/', 'ModalAnalysis_Node_EigenVectors_EigenVec1.out'),
                 '-node', *list(range(5, 9)), '-dof', *[1, 2], 'eigen 1')
    ops.recorder('Node', '-file',
                 os.path.join('../DynamicSystem/Result_files/', 'ModalAnalysis_Node_EigenVectors_EigenVec2.out'),
                 '-node', *list(range(5, 9)), '-dof', *[1, 2], 'eigen 2')
    ops.recorder('Node', '-file',
                 os.path.join('../DynamicSystem/Result_files/', 'ModalAnalysis_Node_EigenVectors_EigenVec3.out'),
    ...
    with open(os.path.join('Result_files/', 'ModalAnalysis_Node_EigenVectors_EigenVal.out'), "w") as eig_file:
...
def run_pushover(m_1, steps=10000, direction='X'):
    ...
    ops.recorder('Node', '-file',
                 os.path.join('../DynamicSystem/Result_files/', file_names[0]),
                 '-time', '-node', *list(range(1, 5)), '-dof', d_o_f, 'reaction')
    # records horizontal displacements of node 3 & 5
    ops.recorder('Node', '-file',
                 os.path.join('../DynamicSystem/Result_files/', file_names[1]),
...
def run_time_history(direction='X', g_motion_id=1, scaling_id=1,
                     lamda=1, acc_dir='Result_files/acc_1.txt', alpha=0.29):
    """
    ...
    if direction == 'X':
        ...
        omega = np.loadtxt(os.path.join('Result_files/', 'ModalAnalysis_Node_EigenVectors_EigenVal.out'), skiprows=1)[0, 1]
        d_o_f = 1
    else:
        ...
        omega = np.loadtxt(os.path.join('Result_files', 'ModalAnalysis_Node_EigenVectors_EigenVal.out'), skiprows=1)[2, 1]
        d_o_f = 2
    ...
    # records horizontal reactions of node 1 to 4
    ops.recorder('Node', '-file',
                 os.path.join('Result_files/', file_names[0]),
                 '-time', '-node', *list(range(1, 5)), '-dof', d_o_f, 'reaction')
    # records horizontal displacements of node 5 to 8
    ops.recorder('Node', '-file',
                 os.path.join('Result_files/', file_names[1]),
                 '-time', '-node', *list(range(5, 9)), '-dof', d_o_f, 'disp')
    # records horizontal accelerations of node 5 to 8
    ops.recorder('Node', '-file',
                 os.path.join('Result_files/', file_names[2]),
                 '-time', '-node', *list(range(5, 9)), '-dof', d_o_f, 'accel')

    # Reading omega for obtaining Rayleigh damping model
    xi = 0.05
