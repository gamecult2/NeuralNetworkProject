# https://github.com/AmirHosseinNamadchi/OpenSeesPy-Examples/blob/master/Two%20Story%20Steel%20MRF%20(FGU).ipynb
...
def run_time_history(g_motion_id=1, scaling_id=1, lamda=1, acc_dir='FGU_2SSMRF_files/acc_1.txt'):
    """
