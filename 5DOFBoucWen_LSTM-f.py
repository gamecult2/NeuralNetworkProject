...
lstm1 = CuDNNLSTM(100, return_sequences=True, stateful=False)(input_layer)
activation1 = Activation('relu')(lstm1)

# CuDNNLSTM layer with return_sequences=True
lstm2 = CuDNNLSTM(100, return_sequences=True, stateful=False)(activation1)
...
output_layer = Dense(num_classes)(dense1)
